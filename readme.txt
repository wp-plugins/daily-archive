...
- This plugin has been tested only in WordPress 4.2.2. 이 플러그인은 워드프레스 4.2.2에서만 테스트되었습니다.
- The title of 'daily-archive' page will be forced to that date. 'daily archive' 페이지의 제목은 해당 날짜로 강제됩니다.
- [source on git](https://github.com/guruahn/daily-archive)
- [demo site](http://guruahn.cafe24.com/wp/daily-archive/)
...
1. This screen shot description daily-index page.